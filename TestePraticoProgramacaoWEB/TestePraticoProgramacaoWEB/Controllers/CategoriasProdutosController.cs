...
namespace TestePraticoProgramacaoWEB.Controllers
{
    public class CategoriasProdutosController : Controller
    {
        private readonly Contexto _context;

        public CategoriasProdutosController(Contexto context)
        {
            _context = context;
        }
        ...
        // For mode details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
